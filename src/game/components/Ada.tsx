...
export function Ada({ expression, size = 48 }: AdaProps) {
  return (
    ...
    >
      ...
      >
        {/* Body */}
        <ellipse cx="32" cy="38" rx="18" ry="20" fill="var(--card)" stroke="var(--border)" strokeWidth="1" />

        {/* Head */}
        <circle cx="32" cy="22" r="16" fill="var(--card)" stroke="var(--border)" strokeWidth="1" />
        ...
        {/* Eye rings */}
        <circle cx="25" cy="22" r="7" fill="var(--page)" stroke="var(--accent)" strokeWidth="1.5" />
        <circle cx="39" cy="22" r="7" fill="var(--page)" stroke="var(--accent)" strokeWidth="1.5" />
        ...
        {expression === "thinking" ? (
          ...
          <>
            <path d="M22 22 Q25 19 28 22" stroke="var(--accent-ink)" strokeWidth="2" strokeLinecap="round" fill="none" />
            <path d="M36 22 Q39 19 42 22" stroke="var(--accent-ink)" strokeWidth="2" strokeLinecap="round" fill="none" />
          </>
        ) : expression === "unbothered" ? (
          <>
            <circle cx="25" cy="23" r="2" fill="var(--text-dim)" />
            <circle cx="39" cy="23" r="2" fill="var(--text-dim)" />
            <line x1="21" y1="20" x2="29" y2="20" stroke="var(--card)" strokeWidth="2.5" />
            <line x1="35" y1="20" x2="43" y2="20" stroke="var(--card)" strokeWidth="2.5" />
          </>
        ) : (
          <>
            <circle cx="25" cy="22" r="2.5" fill="var(--ink)" />
            <circle cx="39" cy="22" r="2.5" fill="var(--ink)" />
          </>
        )}
        ...
        {/* Belly */}
        <ellipse cx="32" cy="42" rx="10" ry="12" fill="var(--page)" stroke="var(--border)" strokeWidth="0.5" />
        ...
        {/* Feet */}
        <path d="M25 56 L22 60 M25 56 L25 60 M25 56 L28 60" stroke="var(--accent-ink)" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M39 56 L36 60 M39 56 L39 60 M39 56 L42 60" stroke="var(--accent-ink)" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </div>
  );
}
